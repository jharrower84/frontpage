  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px;">
        ...
        <div style="border-left: 3px solid #e8a0a0; padding: 12px 16px; margin: 16px 0; background: #fdf2f2; border-radius: 0 8px 8px 0;">
          <p style="font-size: 14px; color: #333; margin: 0;">${commentText}</p>
        </div>
        <a href="https://frontpageapp.com/p/${postSlug}"
          style="display: inline-block; background: #e8a0a0; color: white; padding: 12px 24px; border-radius: 999px; text-decoration: none; font-weight: 600; font-size: 14px; margin-top: 8px;">
          View comment →
        </a>
