    ...
    <div className="min-h-screen flex" style={{ background: "#fff" }}>
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between p-12" style={{ background: "#0a0a0a" }}>
        ...
        <div>
          ...
          <h2 className="text-4xl font-bold text-white leading-tight mb-4" style={{ letterSpacing: "-0.03em" }}>
            Fashion writing<br />for people who<br />mean it.
          </h2>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm mb-8" style={{ color: "#888" }}>Sign in to your FrontPage account</p>
          ...
          <form onSubmit={handleSignIn} className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm focus:outline-none transition-colors rounded-lg"
                style={{ border: "1px solid #e8e8e8", color: "#111", background: "#fff" }}
              />
            </div>
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#999" }}>
                  Password
                </label>
                <Link href="/reset-password" className="text-xs hover:opacity-60 transition-opacity" style={{ color: "#2979FF" }}>
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full px-4 py-3 pr-11 text-sm focus:outline-none transition-colors rounded-lg"
                  style={{ border: "1px solid #e8e8e8", color: "#111", background: "#fff" }}
                />
                <button
                  type="button"
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full py-3 text-sm font-medium flex items-center justify-center gap-3 rounded-lg transition-colors hover:opacity-80"
          ...
          <p className="text-center text-sm mt-8" style={{ color: "#aaa" }}>
            ...
            <Link href="/signup" className="font-semibold hover:opacity-70 transition-opacity" style={{ color: "#111" }}>
              Sign up
            </Link>
          </p>
        </div>
